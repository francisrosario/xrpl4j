package org.xrpl.xrpl4j.model.fl.ledger;
 ...
 *
 * <p>The {@link PaymentChannelCreate} transaction type creates a PayChannel object.
 * The {@link PaymentChannelFund} and
 * {@link PaymentChannelClaim} transaction types modify existing PayChannel objects.
 *
 ...
 * a new {@link PaymentChannelClaim} or
 * {@link PaymentChannelFund} transaction accessing the channel.
 */
@Value.Immutable
...
public interface PayChannelObject extends LedgerObject {
   ...
   *
   * @return Always {@link LedgerObject.LedgerEntryType#PAY_CHANNEL}.
   */
   ...
   * {@link PaymentChannelCreate#destination()} field of the transaction
   ...
   * {@link PaymentChannelCreate} transaction that created the channel and can
   * be increased if the source address sends a {@link PaymentChannelFund}
   * transaction.
   *
   ...
   * {@link PaymentChannelClaim} transactions. If the channel closes,
   ...
   * {@link PaymentChannelCreate} transaction that created the channel and
